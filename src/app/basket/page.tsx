  ...
  if (items.length === 0) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-16 text-center">
        <h1 className="text-2xl font-bold text-[#1b6b80]">Your Basket</h1>
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row">
        <Link
          href="/products"
          className="flex-1 rounded border-2 border-[#1b6b80] py-3 text-center font-semibold text-[#1b6b80] hover:bg-[#eef7f9]"
        >
          Continue Shopping
        </Link>
        <Link
          href="/checkout"
          className="flex-1 rounded bg-[#6b3fd4] py-3 text-center font-semibold text-white hover:bg-[#5c33bd]"
        >
          Proceed to Checkout
        </Link>
      </div>
